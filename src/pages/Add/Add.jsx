    ...
    <div className="add">
      <form className="flex-col" onSubmit={onSubmitHandler}>
        ...
        <div className="add-product-name flex-col">
          <p>Product Name</p>
          <input onChange={onChangeHandler} value={data.name} type="text" name="name" placeholder="type item name here" autoComplete="given-name" />
        </div>
        <div className="add-product-description flex-col">
          <p>Product Description</p>
          <textarea onChange={onChangeHandler} value={data.description} name="description" rows="6" placeholder="type the description here" required></textarea>
        </div>
